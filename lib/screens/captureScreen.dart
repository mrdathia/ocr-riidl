...
class CaptureScreen extends StatefulWidget {
  ...
  CaptureScreen(this.cameras, {super.key});
...
class _CaptureScreenState extends State<CaptureScreen>
  ...
  Widget _cameraTogglesRowWidget() {
    ...
    if (widget.cameras.isEmpty) {
      ...
      for (final CameraDescription cameraDescription in widget.cameras) {
        toggles.add(
          (cameraDescription.lensDirection == CameraLensDirection.external ||
              ...
              ? SizedBox(
                  ...
                  child: RadioListTile<CameraDescription>(
                    ...
                    onChanged: onChanged,
                    selected: cameraDescription.lensDirection ==
    ...
    takePicture().then((XFile? file) {
      if (mounted) {
        ...
        if (file != null) {
          ...
          Navigator.of(context).pushNamed("copyTextPage", arguments: file);
  ...
  //       ? VideoPlayerController.asset(videoFile!.path)
